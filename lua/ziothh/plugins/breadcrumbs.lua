...
local icons = require("ziothh.icons")
...
--   local status_ok, navic = pcall(require, "SmiteshP/nvim-navic")
...
M.get_filename = function()
  ...
  local f = require "ziothh.utils.functions"
...
local get_gps = function()
  ...
  if not require("ziothh.utils.functions").isempty(gps_location) then
